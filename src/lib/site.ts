...
export const founders: readonly TeamMember[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Builds robotics and automation software for a neuron-culture platform at Neurotech@Berkeley",
      "ML intern at Enhanced Ultrasound, building ultrasound segmentation pipelines on Meta's Segment Anything Model",
      "Open source contributor to MDAnalysis, building a progress dashboard for weighted-ensemble simulations",
      "Three years building secure full-stack cloud applications",
      "Took 3rd place at both Los Altos Hacks and Milpitas Hacks, building a wildfire-spread model and a real-time 911 call summarizer",
      "Regents' Scholar at multiple UC campuses, the UC system's most prestigious scholarship",
      "Walt Disney Scholar",
      "Eagle Scout",
    ],
